...
public class WekaDataSet<T> {
     ...
     */
    public WekaDataSet(final List<ParametersWithClass<T>> values,
        ...
        ServiceParameters basedOnParameters = values.get(0).getParameters();
     ...
     */
    public Instance buildTestInstance(final ServiceParameters serviceParameters) {
    ...
    private Instance buildInstance(final ServiceParameters serviceParameters, final double classValue,
            final double weight) {
